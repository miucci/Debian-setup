...
cp "/var/lib/flatpak/app/com.bitwarden.desktop/current/active/export/share/applications/com.bitwarden.desktop.desktop" ~/.config/autostart/ #Autostarting Bitwarden
